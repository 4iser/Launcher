...
def desenhar_pontuacao(p):
	pont = FONTE.render('Points: %s' %p, True, BRANCO)
...
def desenhar_informacoes():
	desenhar_texto('Biltaev and Ivanov present', LARGURA_JANELA / 2, 275)
	desenhar_texto('Press to start', LARGURA_JANELA / 2, 300)
	desenhar_texto('2021', LARGURA_JANELA / 2, 430)
...
def mostrar_tela_fim_de_jogo():
	fim_jogo_fonte = pygame.font.SysFont('arial',45)
	exib = fim_jogo_fonte.render('You lose!', True, BRANCO)
