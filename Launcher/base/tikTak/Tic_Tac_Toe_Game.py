...
def ButtonClick(id):
    ...
    if( bu1['text']=='X' and bu2['text']=='X' and bu3['text']=='X' or
        ...
        bu3['text']=='X' and bu5['text']=='X' and bu7['text']=='X'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("X annd 0","Winner is player 1")
        ...
        bu3['text']=='O' and bu5['text']=='O' and bu7['text']=='O'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("X annd 0","Winner is player 2")
    elif b==9:
            disableButton()
            c=1
            tkinter.messagebox.showinfo("X annd 0","Match is Draw.")
